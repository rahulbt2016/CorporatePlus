<?php
   ...
   if(!$_SESSION['email']){
    ...
    if(!isset($_SESSION['editProductCategoryId']))
        header("Location: dashboard.php");
    
    
    $query="SELECT * FROM product_category WHERE product_category_id=".(int)$_SESSION['editProductCategoryId'];
...
<!--            <h1>Edit Product</h1>-->
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
                ...
                <li class="breadcrumb-item"><a href="productCategories.php">Product Categories</a></li>
...
<!--              <div class="card-header" style="background-color: #007BFF">
              ...
              <div class="card-body" style="height: auto;">
                ...
                <div>
                    <center>
                        <span>
                        <img id='product-category-pic' style='height:300px; width:250px' src='../dashboard_assets/dist/product_pic/<?php echo $categoryImage ?>' class='elevation-2'>
                        </span>
                        <a  data-toggle='dropdown' href='#'>
                            <i id='edit-product-category-pic' class='far fa-edit'></i>
                        </a>
                    </center> 
                </div>
                <input type='file' hidden id='new-pro-cat-pic'>  
                  
                <input type='text' hidden id='pro-cat-id' value="<?php echo $_SESSION['editProductCategoryId'] ?>"> 
                
                <div class="form-group">
                    <label for="exampleInputName1">Category Name</label>
                    <input type="text" readonly class="form-control validate-input1" value="<?php echo $categoryName ?>"  id="product-category-name" placeholder="Enter Product Category Name">
                    <span  class="invalid-feedback">This field can't be empty</span>
                </div>  
                
                <div class="form-group">
                    <label for="exampleInputReason1">Description</label>
                    <textarea name='product-category-description' class='form-control validate-input1' rows='4' id='product-category-description' placeholder='Enter description of the product category'><?php echo $categoryDescription ?></textarea>
                    <span  class="invalid-feedback">Please enter the product category description</span>
                </div>
              ...
              <div class="card-footer">
                  <button  class="btn btn-primary" id="save-edited-product-category">Save</button>
              </div>
            </div>
            <!-- /.card -->
          </div> 
...
$(document).ready(function () {
  bsCustomFileInput.init();
    ...
    $('#edit-product-category-pic').click(function(){
        $('#new-pro-cat-pic').click();
    });
    
    $('#new-pro-cat-pic').change(function(){
    ...
    function readURL(input) {
      if (input.files && input.files[0]) {
        ...
        reader.onload = function(e) {
          $('#product-category-pic').attr('src', e.target.result);
        }
