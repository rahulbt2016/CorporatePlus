          ...
          <div class="col-12">
            <div class="card">
              <div class="card-header" style="background-color: #007BFF">
                <h3 class="card-title" style="color:white">Notifications</h3>
              ...
              <div class="card-body table-responsive p-0" style="height: 390px;">
                <table class="table table-head-fixed">
                  ...
                  <tbody id='notification-page-body'>
                     <?php
                        ...
                        while($row=mysqli_fetch_array($result)){
                            ...
                            echo "
                                ...
                                <a href='".$row['link_page']."' class='dropdown-item'>
                                    ...
                                    <div class='col-md-4'>
                                        <p class='text-sm text-muted' style='text-align:right'><i class='far fa-clock mr-1'></i> ".time_elapsed_string($row['notification_time'])."</p>
                                    </div>
                                    </div>
                                </a>
                                </td>
...
$(function () {
  ...
  function refreshNotificationPage(){
    setInterval(function(){                                                     //For refreshing notification page
        ...
        $.ajax({
                ...
                data:
                    {
                        action:'refresh-notification-page'
                    },
                ...
                success: function(data){
                    $("#notification-page-body").html(data);  
                }
