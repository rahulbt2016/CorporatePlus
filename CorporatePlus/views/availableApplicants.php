        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Show Applicants</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
          ...
          <div class="col-12">
            <div class="card">
                <div class="card-header" style="background-color: #007BFF">
                    <h3 class="card-title" style="color:white">Available Applicant's List</h3>
                ...
                <div class="card-tools">
                  <div class="input-group input-group-sm" style="width: 150px;">
                    ...
                    <div class="input-group-append">
                      <button type="submit" id="table_search" class="btn btn-default"><i class="fas fa-search"></i></button>
                    </div>
                    ...
                    <?php
                        ...
                        while($row=mysqli_fetch_array($result)){
                          ...
                          echo "<tr>
                            ...
                            <td><img height ='100px' width='100px' src=../dashboard_assets/dist/img/".$row['person_image']."></td>
                            ...
                            <td>".$row['work_experience_years']."</td>";
                          ...
                          echo "<td>".$row['interested_field']."</td>
                            ...
                            <td><a data-toggle='dropdown' href='#'><i style='color:red'  class='far fa-trash-alt delete-applicant'></i></a><input hidden type='text' value='".$row['recruitment_id']."'></td>
