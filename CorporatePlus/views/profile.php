          ...
          <!--<img src="../dashboard_assets/dist/img/avatar5.png" class="img-circle elevation-2" alt="User Image">-->
                        <?php
                            ...
                            if(!isset($_SESSION['temp_img'])){
                                ...
                                echo "<center>
                                    <div>
                                    <img id='profile-pic' style='height:200px; width:200px' src='../dashboard_assets/dist/img/".$image_name."' class=' elevation-2' alt='User Image'>
                                        <a  data-toggle='dropdown' href='#'>
                                            <i id='edit-pic' class='far fa-edit'></i>
                                        </a>
                                    </div>
                                </center>";
                            }
                                ...
                                echo "<center>
                                    <div>
                                    <img id='profile-pic' style='height:200px; width:200px' src='../dashboard_assets/dist/img/".$_SESSION['temp_img']."' class=' elevation-2' alt='User Image'>
                                        <a  data-toggle='dropdown' href='#'>
                                            <i id='edit-pic' class='far fa-edit'></i>
                                        </a>
                                    </div>
                                </center>";
                                $tempImg = $_SESSION['temp_img'];
                  ...
                  <div class="form-group">
                    ...
                    <?php echo"<input type='text' name='name' class='form-control validate-input1' value='".$name."' id='user-name2' placeholder='Enter Name'>";?>
                    <span  class="invalid-feedback">Name field can't be empty</span>
                  </div>
                  
                  <div class="form-group">
                    <label for="exampleInputName1">Registration Number</label>
                    <?php echo"<input type='text' readonly name='reg-num' class='form-control' value='".$regNum."' id='user-reg-num2'>";?>
                  </div>    
                    
                  <div class="form-group">
                    <label for="exampleInputName1">Designation</label>
                    <?php echo"<input type='text' name='user-type' class='form-control' value='".$designation."' id='user-type2' readonly>";?>
                  </div>
                    
                  <div class="form-group">
                    <label for="exampleInputName1">Monthly Salary (₹)</label>
                    <?php echo"<input type='text' name='salary' class='form-control' value='".$salary."' id='salary' readonly>";?>
                  </div>

                  <div class="form-group">
                    <label for="exampleInputEmail1">Email Address</label>
                    <?php echo "<input type='email' name='email' class='form-control validate-input1' readonly  value='".$_SESSION['email']."' id='user-email2' placeholder='Enter email'>"; ?>
                    <span  class="invalid-feedback">Please enter a valid email address (eg: abc@xyz.com)</span>
                  </div>

                  <div class="form-group">
                    <label for="exampleInputPassword1">New Password</label>
                    <?php echo "<input type='password' name='password' class='form-control validate-input1' value='".$password."' id='user-password2' placeholder='Password'>"; ?>
                    <span  class="invalid-feedback">Please enter a valid password with minimum length of 8 digits</span>
                  </div>
                    
                  <div class="form-group">
                    <label for="exampleInputPassword1">Confirm Password</label>
                    <?php echo "<input type='password' name='confirm-password' class='form-control validate-input1' value='".$password."' id='confirm-user-password2' placeholder='Password'>"; ?>
                  ...
                  <div class="form-group">
                    ...
                    <?php echo "<input type='text' name='number' class='form-control validate-input1' value='".$number."' id='user-number2' placeholder='Phone Number'>"; ?>
                  ...
                  <div hidden class="form-group">
                    ...
                    <div class="input-group">
                      <div class="custom-file">
                        <input type="file" class="custom-file-input" id="user-pic2">
                  ...
                  <?php
                if(isset($tempImg)){
                    echo "<input hidden type='text' id='temp-img-name' value='".$tempImg."'>";
                }
                else{
                    echo "<input hidden type='text' id='temp-img-name' value='".$image_name."'>";
                }
                ?>
                <!-- /.card-body -->

                <div class="card-footer">
                  <button  class="btn btn-primary" id="edit-profile">Save</button>
                </div>
              </form>
            </div>
            <!-- /.card -->
