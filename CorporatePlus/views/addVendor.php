                ...
                <div class="card-body">
                   ...
                   <div class="form-group">
                    ...
                    <?php
                        ...
                        $result = mysqli_query($con,"SELECT vendor_reg_num from vendor");
                        while($row = mysqli_fetch_array($result)){
                            $lastID = $row['vendor_reg_num'];
                        }
                        ...
                        echo "<input type='text' class='form-control' readonly name='vrn' id='vendor-reg-num' value='".$newID."'>";
                    ?>
                  </div> 
                    
                  <div class="form-group">
                    <label for="exampleInputName1">Vendor Name</label>
                    <input type="text" class="form-control validate-input1" name="name" id="vendor-name" placeholder="Enter Vendor Name">
                    <span  class="invalid-feedback">Vendor Name field can't be empty</span>
                  </div>
                    
                  <div class="form-group">
                    <label for="exampleInputName1">Vendor GST Number</label>
                    <input type="text" class="form-control validate-input1" name="gst-num" id="vendor-gst-num" placeholder="Enter Vendor GST Number">
                    <span  class="invalid-feedback">Please enter a valid GST number (eg: 22AAAAA0000A1Z5)</span>
                  </div>

                  <div class="form-group">
                    <label for="exampleInputEmail1">Email Address</label>
                    <input type="email" class="form-control validate-input1" name="email" id="vendor-email" placeholder="Enter Vendor email">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control validate-input1" name='number' id="vendor-number" placeholder="Vendor Phone Number">
                              ...
                              <div class="row">
                                <div class="col-12">
                                  <div class="form-group">
                                    ...
                                    <select class="duallistbox" multiple="multiple" id="raw-mat">
...
<!--                                    <span  class="invalid-feedback">Please Select atleast 1 raw material</span>-->
                ...
                <div class="card-footer">
                  <button  class="btn btn-primary" id="add-vendor">Submit</button>
                </div>
              </form>
            </div>
            <!-- /.card -->
