          ...
          <div class="col-12">
            <div class="card">
              <div class="card-header" style="background-color: #007BFF">
                <h3 class="card-title" style="color:white">List of all Vendors</h3>
                ...
                <div class="card-tools">
                  <div class="input-group input-group-sm" style="width: 250px;">
                    <?php
                        ...
                        $flag = 0;
                        while($row=mysqli_fetch_array($result)){
                            if($row['form_file']=='addVendor.php')
                            $flag=1;
                        }
                        if($flag){
                            echo "<a data-toggle='dropdown' href='#'><i id='add-vendor-button' style='color:white; padding-top:8px ' title='Add Vendor'  class='far fa-plus-square '></i></a>";  
                        }
                    ?>
                    <input type="text" name="table_search" id='vendor-search-string' style="margin-left:20px" class="form-control" placeholder="Search">

                    <div class="input-group-append">
                      <button type="submit" id='vendor-table-search' class="btn btn-default"><i class="fas fa-search"></i></button>
                    </div>
                  </div>
                </div>
              </div>
...
<!--                      <th>Raw Materials</th>-->
                  ...
                  <tbody id='vendor-table-body'>
                      ...
                      $query="SELECT * FROM vendor ORDER BY active DESC";
                      ...
                      while($row=mysqli_fetch_array($result)){
                        ...
                        echo "<tr>";
                            ...
                            //To print raw materials list
                            /*echo "<td><table>";
                            $result3 = mysqli_query($con,"select * from vendor where vendor_reg_num='".$row['vendor_reg_num']."' ORDER BY raw_mat ASC");
                            while($row3=mysqli_fetch_array($result3)){
                                echo "<tr><td>".$row3['raw_mat']."</td></tr>";
                            }
                            echo "</table></td>";
                            */
