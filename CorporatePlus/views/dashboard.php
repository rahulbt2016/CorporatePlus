        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item has-treeview">
            ...
            <ul class="nav nav-treeview">
              <!--
              <li class="nav-item">
                <a href="../dashboard_assets/pages/forms/general.html" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
...
//                $query = "select access.form_id,form.form_name,form.form_file from access,form where access.form_id=form.form_id and access.designation_name='".$_SESSION['designation']."'";
//                $result = mysqli_query($con,$query);
//                while($row=mysqli_fetch_array($result)){
