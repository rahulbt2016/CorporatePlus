          ...
          <div class="col-md-8">
            ...
            <div class="card card-primary">
              ...
              <?php
                ...
                $result = mysqli_query($con,$query);
            while($row=mysqli_fetch_array($result)){
                $urn = $row['user_reg_num'];
                $name2 = $row['user_name'];
                $number2 = $row['phone'];
                $designation2 = $row['designation_name'];
                $salary2 = $row['user_salary']; 
                $email2 = $row['email'];
                $active2 = $row['active'];
            }
              ?>
              <form role="form">
                <div class="card-body">
                  ...
                  <div class="form-group">
                    ...
                    <?php echo"<input type='text' readonly name='urn' class='form-control' value='".$urn."' id='urn3' >";?>
                  </div>
                    
                    
                  <div class="form-group">
                    <label for="exampleInputName1">Name</label>
                    <?php echo"<input type='text' name='name' class='form-control validate-input1' value='".$name2."' id='user-name3' placeholder='Enter Name'>";?>
                  ...
                  <div class="form-group">
                    ...
                    <?php
                        ...
                        if($email2!=$_SESSION['email']){
                           echo "<select class='form-control validate-input1'  placeholder='Select Type' id='user-type3'>"; 
                           $query = "SELECT designation_name FROM designation";
                            $result = mysqli_query($con,$query);
                            while($row=mysqli_fetch_array($result)){
                                
                                if($row['designation_name']==$designation2){
                                    echo "<option selected>".$row['designation_name']."</option>";
                                }
                                else{
                            ...
                            while($row=mysqli_fetch_array($result)){
                                ...
                                echo "<input type='text' class='form-control' readonly id='user-type3' value='".$row['designation_name']."'>";
                                break;
                            }
                  ...
                  <div class="form-group">
                    ...
                    <?php 
                        if($email2!=$_SESSION['email']){
                            echo"<input type='number' class='form-control validate-input1' name='salary' value='".$salary2."' id='salary3'>"; 
                     
                        }
                        else{
                            echo"<input type='number' readonly class='form-control validate-input1' name='salary' value='".$salary2."' id='salary3'>"; 
                        }
                    ?>
                  ...
                  <div class="form-group">
                    ...
                    <?php echo "<input type='email' name='email' class='form-control validate-input1' value='".$email2."' id='user-email3' placeholder='Enter email'>"; ?>
                  ...
                  <div class="form-group">
                    ...
                    <?php echo "<input type='text' name='number' class='form-control validate-input1' value='".$number2."' id='user-number3' placeholder='Phone Number'>"; ?>
                ...
                <div class="card-footer">
                  <button  class="btn btn-primary" id="save-edited-user">Save</button>
                </div>
              </form>
            </div>
            <!-- /.card -->
