          ...
          <div class="col-12">
            <div class="card">
              <div class="card-header" style="background-color: #007BFF">
                <h3 class="card-title" style="color:white">List of Manufactured Products</h3>
                ...
                <table class="table table-head-fixed table-hover text-nowrap">
                  <thead>
                    <tr>
                      ...
                      <th>Raw Materials'<br>Quantity</th>
                      <th>Status</th>
                    </tr>
                  </thead>
                  <tbody id="manufactured-product-table-body">
                      ...
                      $query="SELECT products_manufactured.product_manufacture_id,
                            ...
                            ORDER BY products_manufactured.manufacture_date DESC, 
                            products_manufactured.product_manufacture_id DESC";
                      
                      $result = mysqli_query($con,$query);
                      while($row=mysqli_fetch_array($result)){
                       
//                       $result2 = mysqli_query($con,"SELECT * from products_manufactured where product_manufacture_id=".(int)$row['product_manufacture_id']);   
//                       while($row2 = mysqli_fetch_array($result2)){
//                           $qualityCheckerId = $row2['quality_check_by'];
//                       }   
