          ...
          <div class="col-md-8">
            ...
            <div class="card card-primary">
              <div class="card-header">
                <h3 class="card-title">On-site Inquiry</h3>
              </div>
              <!-- /.card-header -->
              <!-- form start -->
                ...
                <div class="card-body">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control validate-input1" name='inquiry-name' id="inquiry-name" placeholder="Name">
                    <span  class="invalid-feedback">Name field can't be empty</span> 
                  </div>

                  <div class="form-group">
                    <label for="exampleInputEmail1">Email Address</label>
                    <input type="email" class="form-control validate-input1" name="inquiry-email" id="inquiry-email" placeholder="Email ID">
                    <span  class="invalid-feedback">Please enter a valid email address (eg: abc@xyz.com)</span>
                  </div>

                   <div class="form-group">
                    <label for="exampleInputNumber1">Phone Number</label>
                    <input type="number" class="form-control validate-input1" name='inquiry-number' id="inquiry-number" placeholder="Phone Number">
                  ...
                  <!--div class="form-group">
                    <label for="exampleInputProductId1">Product ID</label>
                    <!--?php 
                    /*$result = mysqli_query($con, "SELECT 
                            products.product_id,
                            products.product_code,
                    ...
                    echo "<input type='text' class='form-control validate-input1' name='inquiry-product-id' id='inquiry-product-id' value='".$row['product_code']."' readonly>"; ?>
                  </div-->
                  ...
                  <div class="form-group">
                    <label for="exampleInputTaker1">Inquiry Taken by</label>
                    <?php echo"<input type='text' name='user-type' class='form-control' value='".$adderID."' id='inquiry-taker' readonly>";?>
                  </div>


                  <div class="form-group">
                        <label for="exampleInputAllocated1">Inquiry Allocated To</label>
                        <select class="form-control" placeholder="Select Employee" id="inquiry-allocated">
                        <?php
                        $result = mysqli_query($con, "select * from user ORDER BY user_name ASC");
                        while($row=mysqli_fetch_array($result)){
                  ...
                  <!--div class="form-group">
                        ...
                        <div class="custom-control custom-checkbox">
                          ...
                          <input class="custom-control-input" type="checkbox" id="follow-up-status">
                            <label for="follow-up-status" class="custom-control-label">Follow Up (Inquiry for second time):</label>
                    ...
                    <div class="form-group">
                      ...
                      <div class="input-group">
                        ...
                        <input type="date" class="form-control" data-inputmask-alias="datetime" data-inputmask-inputformat="dd/mm/yyyy" data-mask placeholder="dd/mm/yy">
                      </div>
                      <!-- /.input group -->
                    <!--/div>
                    ...
                    <div class="form-group">
                        <label>Follow Up Reasons </label>
                        <textarea class="form-control" rows="10" placeholder="Enter the reason"></textarea>
                        <span  class="invalid-feedback">Reason field can't be empty</span>
                    </div>
