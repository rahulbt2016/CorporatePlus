  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Ordered Raw Materials</h1>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
                <li class="breadcrumb-item"><a href="dashboard.php">Home</a></li>
              <li class="breadcrumb-item active">Ordered Raw Materials</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
          ...
          <div class="col-12">
            <div class="card">
              <div class="card-header" style="background-color: #007BFF">
                <h3 class="card-title col-md-9" style="color:white">List of Ordered Raw Materials</h3>
                ...
                <div class="card-tools col-md-3">
                  <div class="input-group input-group-sm">
                      <?php
                        ...
                        if($flag)
                            echo "<a data-toggle='dropdown' href='#'><i id='add-new-raw-mat-order' style='color:white; padding-top:8px ' title='New Order Entry'  class='far fa-plus-square '></i></a>";
                      ?>
                    <input type="text" name="table_search" style="margin-left:20px" id='ordered-raw-mat-search-string' class="form-control" placeholder="Search">

                    <div class="input-group-append">
                      <button type="submit" id='ordered-raw-mat-search-button' class="btn btn-default"><i class="fas fa-search"></i></button>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div class="card-body table-responsive p-0" style="height: 300px;">
                <table class="table table-head-fixed table-hover text-nowrap">
                  ...
                  <tbody id='ordered-raw-mat-search-table'>
                      <?php
                      
                      //$query="SELECT DISTINCT vendor_reg_num,vendor_name,gst_num,email,phone,raw_mat,added_by FROM vendor";
                      $query="SELECT * FROM raw_material_orders ORDER BY delivery_date DESC, raw_mat_order_id DESC";
           ...
           <div class="col-12">
            <div class="card">
              <div class="card-header" style="background-color: #007BFF">
                <h3 class="card-title" style="color:white">Find Vendor Assist</h3>
              ...
              <div class="card-body" style="height: auto;">
                  ...
                  <select id="raw-mat-find" class="form-control select2" style="width: 100%;">  
                    <?php
                  ...
                  <div>
                  <button  class="btn btn-primary float-sm-right" id="vendor-assist-go">Go</button>
                </div>
                  
                 <br>
                 <br>
                
                <label id="vendor-assist-label">Vendors having Raw Material - :</label> 
                <div id="vendor-assist-div" class="card-body table-responsive p-0" style="height: 300px;">
...
$(document).ready(function () {
 ...
 //Initialize Select2 Elements
   ...
   $("#vendor-assist-label").hide();
   $("#vendor-assist-div").hide();
   
   $("#add-new-raw-mat-order").click(function(){
    window.location='addRawMaterialOrder.php';
  });
