          ...
          <div class="col-12">
            <div class="card">
              <div class="card-header" style="background-color: #007BFF">
                <h3 class="card-title" style="color:white">List of Ordered Raw Materials</h3>
                ...
                <div class="card-tools">
                  <div class="input-group input-group-sm" style="width: 250px;">
                      ...
                      ?>
                    <input type="text" name="table_search" style="margin-left:20px" class="form-control" placeholder="Search">
                      ...
                      <?php
                         $query2 = "select access.form_id, form.form_file from access,form where access.form_id=form.form_id and access.designation_name='".$_SESSION['designation']."'";
                            ...
                            if($flag){
                                ...
                                echo "<th>Return<br/>(Defective)</th>";
                            }
                        ?>
