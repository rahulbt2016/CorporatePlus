          ...
          <div class="col-12">
            <div class="card">
                <div class="card-header" style="background-color: #007BFF">
                    <h3 class="card-title col-md-9" style="color:white">On-Site Inquiries Done</h3>
                ...
                <div class="card-tools col-md-3">
                  <div class="input-group input-group-sm">
                      <?php
                        ...
                        $flag = 0;
                        while($row=mysqli_fetch_array($result)){
                            if($row['form_file']=='addInquiry.php')
                            $flag=1;
                        }
                        if($flag)
                            echo "<a data-toggle='dropdown' href='#'><i id='add-inquiry-button' style='color:white; padding-top:8px ' title='Add Inquiry'  class='far fa-plus-square '></i></a>";
                      ?>
                    <input type="text" name="table_search" style="margin-left:20px" id="onsite-inquiry-search-string"  class="form-control" placeholder="Search">

                    <div class="input-group-append">
                      <button type="submit" class="btn btn-default" id="onsite-inquiry-table-search"><i class="fas fa-search"></i></button>
                    </div>
                  </div>
                </div>
              ...
              <div class="card-body table-responsive p-0" style="height: 390px;">
                <table class="table table-head-fixed table-hover text-nowrap">
                  ...
                  <tbody id="onsite-inquiry-table-body">
                    <?php
                        $query = "select * from onsite_inquiry ORDER BY inquiry_date DESC, inquiry_id DESC";
                        $result = mysqli_query($con,$query);
                        while($row=mysqli_fetch_array($result)){
...
<script src="../dashboard_assets/dist/js/dashboard.js"></script>
...
$("#add-inquiry-button").click(function(){
    
    <?php $_SESSION['inquiryPageFlag'] = 0; ?>
