          ...
          <div class="col-12">
            <div class="card">
              <div class="card-header" style="background-color: #007BFF">
                <h3 class="card-title col-md-9" style="color:white">List of Sales</h3>
                ...
                <div class="card-tools col-md-3">
                  <div class="input-group input-group-sm">
                    <?php
                        ...
                        if($flag){
                            echo "<a data-toggle='dropdown' href='#'><i id='add-new-sale-button' style='color:white; padding-top:8px ' title='Add New Sale Entry'  class='far fa-plus-square '></i></a>";  
                        }
                    ?>
                    <input type="text" name="table_search" id='sale-search-string' style="margin-left:20px" class="form-control" placeholder="Search">

                    <div class="input-group-append">
                      <button type="submit" id='sale-table-search' class="btn btn-default"><i class="fas fa-search"></i></button>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div class="card-body table-responsive p-0" style="height: 390px;">
                <table class="table table-head-fixed table-hover text-nowrap">
                  ...
                  <tbody id="sale-table-body">
                      <?php
                        $result = mysqli_query($con,"SELECT * FROM sale ORDER BY sale_date DESC, sale_id DESC");
                        while($row=mysqli_fetch_array($result)){
                            echo "<tr>";
                            ...
                            $result2 = mysqli_query($con,"SELECT * FROM user WHERE user_id=".(int)$row['seller_id']);
                            while($row2=mysqli_fetch_array($result2)){
                                $sellerRegNum = $row2['user_reg_num'];
                                break;        
                            }
                            echo "<td>".$sellerRegNum."</td>";
...
$(function () {
  //Bootstrap Duallistbox
    ...
    $("#add-new-sale-button").click(function(){
        
        <?php $_SESSION['addSaleFlag'] = 0; ?>
