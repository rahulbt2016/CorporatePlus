        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
                ...
                <li class="breadcrumb-item"><a href="servicedProducts.php">Serviced Products</a></li>
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row">
           ...
           <div class="col-12">
            <div class="card">
              <div class="card-header" style="background-color: #007BFF">
                <h3 class="card-title" style="color:white">Find Product</h3>
              ...
              <div class="card-body" style="height: auto;">
                ...
                <div class="form-group">
                  <label>Select Product Batch Number</label>
                  <select id="product-batch-number" class="form-control select2" style="width: 100%;">
                    <?php
                        $result = mysqli_query($con, "SELECT * FROM products_manufactured WHERE status=1 ORDER BY batch_number ASC");
                        while($row=mysqli_fetch_array($result)){
                            echo "<option>".$row['batch_number']."</option>";
                        }
                    ?>
                  </select>
              ...
              <div class="card-footer">
                  <button  class="btn btn-primary" id="search-service-product">Go</button>
              </div>
            </div>
            <!-- /.card -->
          </div> 
           ...
           <div class="col-12" id='new-service-div'>
            <div class="card">
              <div class="card-header" style="background-color: #007BFF">
                <h3 class="card-title" style="color:white">New Service</h3>
              ...
              <div class="card-body" style="height: auto;">
                ...
                <div id='new-service-body'>
                  <div class="form-group">
                    ...
                    <?php
                        ...
                        echo "<input type='text' class='form-control' readonly name='service-reg-num' id='service-reg-num' value='".$newID."'>";
                    ?>
                </div>  
                
                <div class="form-group">
                    <label for="exampleInputName1">Batch Number</label>
                    <input type="text" readonly class="form-control"  id="batch-number">
                </div>  
                ...
                <div class="form-group">
                    ...
                    <input type="text" readonly class="form-control"  id="customer-name">
                </div>   
                  
                <div class="form-group">
                    <label for="exampleInputName1">Customer Email</label>
                    <input type="text" readonly class="form-control"  id="customer-email">
                </div>
                  
                  
                <div class="form-group">
                    <label for="exampleInputName1">Customer Phone Number</label>
                    <input type="text" readonly class="form-control"  id="customer-phone">
                </div>  
                 
                </div>  
                  
                <div class="form-group">
                    <label for="exampleInputReason1">Service Reason (Defect in Product)</label>
                    <textarea name='product-defect' class='form-control validate-input1' rows='4' id='product-defect' placeholder='Enter defect in the product'></textarea>
                    <span  class="invalid-feedback">This field can't be empty</span>
                </div>  
                  
                <div class="form-group">
                  <label>Date of Product Submission</label>

                  <div class="input-group">
                    <div class="input-group-prepend">
                      <span class="input-group-text"><i class="far fa-calendar-alt"></i></span>
                    </div>
                    <input type="date" class="form-control validate-input1" value='<?php echo date("Y-m-d") ?>' id='submit-date' data-inputmask-alias="datetime" data-inputmask-inputformat="dd/mm/yyyy" data-mask placeholder="dd/mm/yy">
                ...
                <div class="form-group">
                  <label>Date of Returning Product (Expected)</label>
                ...
                <div class="form-group">
                    <label for="exampleInputNumber1">Service Charges(₹)</label>
                    <input type="number" class="form-control validate-input1" name='service-cost' min='0' value="0" id="cost" placeholder="Enter Service Cost">
                    <span  class="invalid-feedback">Please enter valid charges</span>
                </div>  
              ...
              <div class="card-footer">
                  <button  class="btn btn-primary" id="add-new-service">Submit</button>
              </div>
            </div>
            <!-- /.card -->
          </div>  
