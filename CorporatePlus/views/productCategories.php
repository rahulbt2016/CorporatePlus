        ...
        <div class="row">
            ...
            <div class="col-md-7">
              ...
              <div class="card-header" style="background-color: #007BFF">
                <h3 class="card-title" style="color:white">List of Product Categories</h3>

                <div class="card-tools">
                  <div class="input-group input-group-sm" style="width: 250px;">
                    <input type="text" name="table_search" id='product-category-search-string' style="margin-left:20px" class="form-control" placeholder="Search">

                    <div class="input-group-append">
                      <button type="submit" id='product-category-table-search' class="btn btn-default"><i class="fas fa-search"></i></button>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div class="card-body table-responsive p-0" style="height: 410px;">
                <table class="table table-head-fixed table-hover text-nowrap">
                  ...
                  <tbody id="product-category-table-body">
                      ...
                      $query="SELECT * FROM product_category ORDER BY active DESC, category_name ASC";
            ...
            <div class="col-md-5">
                ...
                <div class="card">
              <div class="card-header" style="background-color: #007BFF">
                <h3 class="card-title" style="color:white">Add New Product Category</h3>
              ...
              <div class="card-body" style="height: auto;">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control validate-input1"  id="product-category-name" placeholder="Enter Product Category Name">
                    <span  class="invalid-feedback">This field can't be empty</span>
                </div>  
                  
                <div class="form-group">
                    <label for="exampleInputReason1">Description</label>
                    <textarea name='product-description' class='form-control validate-input1' rows='3' id='product-category-description' placeholder='Enter description of the product category'></textarea>
                    <span  class="invalid-feedback">Please enter the product category description</span>
                </div>    
                
                  
                <div class="form-group">
                <label for="exampleInputFile">Product Category Image</label>
                <div class="input-group">
                  <div class="custom-file">
                    <input type="file" class="custom-file-input" id="product-category-pic">
              ...
              <div class="card-footer">
                  <button  class="btn btn-primary" id="add-new-product-category">Submit</button>
              </div>
            </div>
