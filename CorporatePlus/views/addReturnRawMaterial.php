<?php
   ...
   if(!$_SESSION['email']){
    ...
    if(!isset($_SESSION['return-raw-mat-order-id']))
        header("Location: dashboard.php");
    
    
    $result = mysqli_query($con, "SELECT * FROM raw_material_orders where raw_mat_order_id=".$_SESSION['return-raw-mat-order-id']);
    while($row = mysqli_fetch_array($result)){
    ...
    $query2 = "SELECT user_reg_num from user WHERE user_id=".$orderedById;
    $result2 = mysqli_query($con,$query2);
    while($row2=mysqli_fetch_array($result2)){
        $orderByRegNum = $row2['user_reg_num'];
        break;
    }

    $query3 = "SELECT * from raw_materials WHERE raw_mat_id=".$rawMatId;
    $result3 = mysqli_query($con,$query3);
    while($row3=mysqli_fetch_array($result3)){
        $rawMatName = $row3['name'];
        break;
    }

    $query4 = "SELECT * from vendor WHERE vendor_id=".$vendorId;
    $result4 = mysqli_query($con,$query4);
    while($row4=mysqli_fetch_array($result4)){
        $vendorName = $row4['vendor_name'];
        break;
    }
    
    if((int)$quantityInStock<=0){
        header("Location: http://localhost/CorporatePlus/views/orderedRawMaterials.php");
    }
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Add New Returned Raw Material</h1>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
                <li class="breadcrumb-item"><a href="dashboard.php">Home</a></li>
                <li class="breadcrumb-item"><a href="orderedRawMaterials.php">Ordered Raw Materials</a></li>
              <li class="breadcrumb-item active">Add New Returned Raw Material</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
           ...
           <div class="col-12">
            <div class="card">
              <div class="card-header" style="background-color: #007BFF">
                <h3 class="card-title" style="color:white">New Return Entry</h3>
              ...
              <div class="card-body" style="height: 920px;">
                ...
                <div class="form-group">
                    <label for="exampleInputName1">Vendor (raw material bought from)</label>
                    <input type='text' class='form-control validate-input1'  value='<?php echo $vendorName ?>'  id='ven-name' readonly>
                </div>  
                  
                
                <div class="form-group">
                    <label for="exampleInputName1">Raw Material (to be returned)</label>
                    <input type='text' class='form-control validate-input1' value='<?php echo $rawMatName ?>' id='raw-mat-name' readonly>
                </div>  
                  
                  
                <div class="form-group">
                    <label for="exampleInputName1">Quantity Ordered</label>
                    <input type='number' class='form-control validate-input1' readonly id='quantity' value='<?php echo $quantityOrdered ?>'>
                </div>
                  
                <div class="form-group">
                  <label>Select Quantity Returned</label>
                  <select id="returned-quantity" class="form-control select2" style="width: 100%;">
                    <?php
                ...
                <div class="form-group">
                    <label for="exampleInputNumber1">Unit Cost(₹)</label>
                    <input type="number" class="form-control validate-input1" id="cost" readonly value="<?php echo $unitCost ?>">
                </div>  
            
                <div class="form-group">
                    <label for="exampleInputName1">Batch Number</label>
                    <input type='number' class='form-control validate-input1' id='batch-number' readonly value="<?php echo $batchNum ?>">
                </div>  
                
                  
                <div class="form-group">
                  <label>Date of raw material delivery</label>

                  <div class="input-group">
                    <div class="input-group-prepend">
                      <span class="input-group-text"><i class="far fa-calendar-alt"></i></span>
                    </div>
                      <input type="text" class="form-control validate-input1" id='delivery-date' data-inputmask-alias="datetime" data-inputmask-inputformat="dd/mm/yyyy" readonly data-mask value='<?php echo date("d-m-Y", strtotime($deliveryDate)) ?>'>
                  </div>
                  <!-- /.input group -->
                </div>   
                ...
                <div class="form-group">
                  ...
                  <div class="input-group">
                    <div class="input-group-prepend">
                      ...
                      <input type="date" class="form-control validate-input1" value="<?php echo date("Y-m-d") ?>" id='return-date' data-inputmask-alias="datetime" data-inputmask-inputformat="dd/mm/yyyy" data-mask placeholder="dd/mm/yy">
                ...
                <div class="form-group">
                        <label>Reason for returning / Defect</label>
                        <textarea class="form-control validate-input1" id='reason' rows="5" placeholder="Enter the issue"></textarea>
                        <span  class="invalid-feedback">This field can't be empty</span>
                </div>  
              ...
              <div class="card-footer">
                  <button  class="btn btn-primary" id="return-raw-mat-submit">Submit</button>
                  <input type="text" hidden id="return-raw-mat-order-id" value="<?php echo $_SESSION['return-raw-mat-order-id'] ?>">
                  <input type="text" hidden id="quantity-in-stock" value="<?php echo $quantityInStock ?>">
