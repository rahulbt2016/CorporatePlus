          ...
          <div class="col-md-8">
            <div class="card">
              <div class="card-header" style="background-color: #007BFF">
                <h3 class="card-title col-md-9" style="color:white">List of Raw Materials</h3>

                <div class="card-tools col-md-3">
                  <div class="input-group input-group-sm">
                      
                    <input type="text" name="table_search" id='raw-mat-search-string'  class="form-control" placeholder="Search">

                    <div class="input-group-append">
                      <button type="submit" id='raw-mat-search-button' class="btn btn-default"><i class="fas fa-search"></i></button>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div class="card-body table-responsive p-0" style="height: 390px;">
                <table class="table table-head-fixed table-hover text-nowrap">
                  <thead>
                      ...
                      <th>Added By</th>
                      <th>Status</th>
                      <th>Disable/<br/>Enable</th>
                    </tr>
                  </thead>
                  <tbody id='raw-mat-search-body'>
                      <?php
           ...
           <div class="col-md-4">
            <div class="card">
              <div class="card-header" style="background-color: #007BFF">
                <h3 class="card-title" style="color:white">Add New Raw Material</h3>
              ...
              <div class="card-body" style="height: auto;">
                  ...
                  <div class="form-group">
                    <label for="exampleInputName1">Raw Material Code</label>
                    <?php
                       
                        $tableName = "raw_materials";
                        $columnName = "raw_mat_code";
                        $prefix = "RWM";
                        ...
                        echo "<input type='text' class='form-control' readonly name='rwm-code' id='rwm-code' value='".$newID."'>";
                    ?>
                  </div> 
                    
                  <div class="form-group">
                    <label for="exampleInputName1">Raw Material Name</label>
                    <input type="text" class="form-control validate-input1" name="name" id="rwm-name" placeholder="Enter Raw Material Name">
              ...
              <div class="card-footer">
                  <button  class="btn btn-primary" id="add-new-raw-mat">Submit</button>
                </div>
