              ...
              <form role="form">
                <div class="card-body">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control validate-input1" name="name" id="person-name" placeholder="Enter Name">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control validate-input1" name='number' id="person-number" placeholder="Phone Number">
                    <span  class="invalid-feedback">Please enter a valid mobile number (10 digit)</span>
                  </div>

                  <div class="form-group">
                    <label for="exampleEducationalQualification1">Educational Qualification</label>
                  </div>
                    <div class="form-group">
                        <label for="exampleSSCper1">10th (%)</label>
                        <input type="number" class="form-control validate-input1" name='ssc' id="person-ssc" placeholder="Enter 10th Standard Percentage">
                        <span  class="invalid-feedback">This field can't be empty</span>
                    </div>

                    <div class="form-group">
                    <label for="exampleInputFile10">10th Marksheet</label>
                    <div class="input-group">
                      <div class="custom-file">
                        <input type="file" class="custom-file-input" id="marksheet-ssc">
                        <label class="custom-file-label" for="exampleInputFile10">Choose file</label>
                      </div>
                    </div>
                  </div>

                    <div class="form-group">
                        <label for="exampleHSCper1">12th (%)</label>
                        <input type="number" class="form-control validate-input1" name='hsc' id="person-hsc" placeholder="Enter 12th Standard Percentage">
                        <span  class="invalid-feedback">This field can't be empty</span>
                    </div>

                    <div class="form-group">
                    <label for="exampleInputFile12">12th Marksheet</label>
                    <div class="input-group">
                      <div class="custom-file">
                        <input type="file" class="custom-file-input" id="marksheet-hsc">
                        <label class="custom-file-label" for="exampleInputFile12">Choose file</label>
                      </div>
                    </div>
                  </div>

                    <div class="form-group">
                        <label for="exampleDiplomaper1">Diploma (%)</label>
                        <input type="text" class="form-control validate-input1" name='diploma' id="person-diploma" placeholder="Enter Diploma Percentage">
                        <span  class="invalid-feedback">This field can't be empty</span>
                    </div>

                    <div class="form-group">
                    <label for="exampleInputFileD2D">Diploma Marksheet</label>
                    <div class="input-group">
                      <div class="custom-file">
                        <input type="file" class="custom-file-input" id="marksheet-d2d">
                        <label class="custom-file-label" for="exampleInputFile10">Choose file</label>
                      </div>
                    </div>
                  </div>
                    ...
                    <div class="form-group">
                        <label for="exampleHighestQualification1">Choose your highest qualification</label>
                    ...
                    <div class="form-group">
                        <label for="exampleSpecialization1">Choose your Specialization</label>
                  ...
                  <div class="form-group">
                    <label for="exampleWorkExperience1">Work Experience</label>
                  ...
                  <div class="form-group">
                    <label for="exampleInputFileAddDoc">Resume</label>
                    <div class="input-group">
                      <div class="custom-file">
                        <input type="file" class="custom-file-input" id="additional-doc">
                        <label class="custom-file-label" for="exampleInputAddDoc">Choose file</label>
                      </div>
                    </div>
                  </div>
                    
                  <div class="form-group">
                    <label for="exampleInterestedField1">Interested Field</label>
                  ...
                  <div class="form-group">
                    <label for="exampleInputFile">Person Image</label>
                    <div class="input-group">
                      <div class="custom-file">
                        <input type="file" class="custom-file-input" id="person-img">
                ...
                <div class="card-footer">
                  <button  class="btn btn-primary" id="add-applicant">Submit</button>
                </div>
              </form>
            </div>
            <!-- /.card -->
