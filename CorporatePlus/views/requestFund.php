        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Request Fund</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
      ...
      <div class="container-fluid">
        <div class="row">
              ...
              <div class="card-body table-responsive p-0" style="height: 390px;">
                <table class="table table-head-fixed table-hover text-nowrap">
                  ...
                  <tbody id="product-table-body">
                      ...
                      $query="SELECT fund.request_id,user.user_id,user.email,fund.request_date,fund.amount,fund.reason,fund.status 
                            FROM fund,user
                            WHERE 
          ...
          <div class="col-md-3">
            <div class="card">
              <div class="card-header" style="background-color: #007BFF">
                <h3 class="card-title" style="color:white">Make New Fund Request</h3>
              ...
              <div class="card-body" style="height: 390px;">
                  ...
                  <div class="form-group">
                    ...
                    <input type='number' name='amount' class='form-control validate-input1' value="amount" id="amount" placeholder='Enter Amount Needed'>
                  ...
                  <div class="form-group">
                    ...
                    <textarea name='reason' class='form-control validate-input1' rows='4' id='reason' placeholder='Enter reason for requesting amount'></textarea>
                    <span  class="invalid-feedback">Please enter the reason</span>
                  </div>
                  
                  <div class="card-footer">
                  <button  class="btn btn-primary" id="request-fund">Submit</button>
                </div>
