          ...
          <div class="col-12">
            <div class="card">
                <div class="card-header" style="background-color: #007BFF">
                    <h3 class="card-title col-md-9" style="color:white">List of all Users</h3>
                ...
                <div class="card-tools col-md-3">
                  <div class="input-group input-group-sm">
                      <?php
                        ...
                        $flag = 0;
                        while($row=mysqli_fetch_array($result)){
                            if($row['form_file']=='addUser.php')
                            $flag=1;
                        }
                        if($flag)
                            echo "<a data-toggle='dropdown' href='#'><i id='add-user-button' style='color:white; padding-top:8px ' title='Add User'  class='far fa-plus-square '></i></a>";
                      ?>
                    <input type="text" name="table_search" style="margin-left:20px" id="user-search-string"  class="form-control" placeholder="Search">

                    <div class="input-group-append">
                      <button type="submit" class="btn btn-default" id="user_table_search"><i class="fas fa-search"></i></button>
                    </div>
                  </div>
                </div>
              </div>
                        ...
                        while($row=mysqli_fetch_array($result)){
                          ...
                          echo "<tr>
                            ...
                            if($flag){
                              ...
                              echo "<div class='modal fade' id='modal-primary-".$row['user_id']."'>
                                <div class='modal-dialog'>
                                    <div class='modal-content bg-primary'>
                                        <div class='modal-header'>
                                            <h4 class='modal-title'>User Description</h4>
                                    ...
                                    echo "<div class='row'>
                                            <div class='col-12' style='margin-bottom:25px'><center><img style='height:200px; width:250px;background-color:white' src='../dashboard_assets/dist/img/".$row['user_photo']."' class=' elevation-2' alt='Product Image'></center></div>

                                            <div class='col-4'>Name</div><div class='col-1'>:</div><div class='col-7'>".$row['user_name']."</div>
                                            <div class='col-4'>Email</div><div class='col-1'>:</div><div class='col-7'>".$row['email']."</div>
                                            <div class='col-4'>Phone</div><div class='col-1'>:</div><div class='col-7'>".$row['phone']."</div>    
                                            <div class='col-4'>Designation</div><div class='col-1'>:</div><div class='col-7'>".$row['designation_name']."</div>
                                            <div class='col-4'>Salary</div><div class='col-1'>:</div><div class='col-7'>₹ ".$row['user_salary']."</div>
