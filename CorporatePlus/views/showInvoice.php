<?php
   ...
   if(!$_SESSION['email']){
    ...
    if(!isset($_SESSION['saleInvoiceGenSaleID']))
        header("Location: dashboard.php");
    
    
    $saleId = (int)$_SESSION['saleInvoiceGenSaleID'];
...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content" id='printing-content'>
      <div class="container-fluid">
        <div class="row">
          <div class="col-12">
            ...
            <div class="invoice p-3 mb-3">
              ...
              <div class="row">
                <div class="col-12">
                  <h4>
                      <img src="../dashboard_assets/dist/img/logo2NewNoBG.png" style='height:50px;width:50px'> Corporate Plus Pvt. Ltd.
                    <small class="float-right">Date: <?php echo date("d M, Y",strtotime($date)) ?></small>
                  </h4>
                </div>
                <!-- /.col -->
              </div>
              ...
              <div class="row invoice-info">
                <div class="col-sm-4 invoice-col">
                  From
                  <address>
                    <strong>Corporate Plus Pvt. Ltd.</strong><br>
                    Anand Sojitra Road <br>
                    Anand - 388120, Gujarat<br>
                    Phone: 9900998877<br>
                    Email: corporate.plus.erp@gmail.com
                  </address>
                </div>
                <!-- /.col -->
                <div class="col-sm-5 invoice-col">
                  ...
                  <address>
                    ...
                    <?php echo $address ?><br>
                    <?php echo $city." - ".$pinCode.", ".$state?><br>
                ...
                <div class="col-sm-3 invoice-col">
                  <b>Invoice #<?php echo $invoiceNumber ?></b>
                           ...
                           while($row = mysqli_fetch_array($result)){
                               echo "<tr>";
                                ...
                                $result2 = mysqli_query($con,"SELECT products_manufactured.batch_number
                                                              FROM products_manufactured,sale_product_batch_numbers
                                                        ...
                                                        ");
                                while($row2 = mysqli_fetch_array($result2)){
                                    echo "<div class='col-12'>".$row2['batch_number']."</div>";
                                }
              ...
              <div class="row" style='margin-top: 50px'>
                ...
                <div class="col-6">
                  ...
                  <img src="../dashboard_assets/dist/img/credit/visa.png" alt="Visa">
                  <img src="../dashboard_assets/dist/img/credit/mastercard.png" alt="Mastercard">
                  <img src="../dashboard_assets/dist/img/credit/paypal2.png" alt="Paypal">
              ...
              <div class="row no-print">
                <div class="col-12">
                  <a href="#" class="btn btn-default" id='print-invoice'><i class="fas fa-print"></i> Print</a>
