...
//    unset($_SESSION['industrialApplicationId']);
    ...
    if(!isset($_SESSION['followInqID']))
        header("Location: dashboard.php");
    
    $inqID = $_SESSION['followInqID'];
?>
      ...
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
              ...
              <h1>Inquiry Follow Up</h1>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
                <li class="breadcrumb-item"><a href="dashboard.php">Home</a></li>
                <li class="breadcrumb-item"><a href="displayInquiries.php">Display Inquiries</a></li>
                <li class="breadcrumb-item active">Inquiry Follow Up</li>
        ...
        <div class="row">
          ...
          <div class="col-md-12">
            ...
            <div class="card card-primary">
                ...
                <h3 class="card-title" style="color:white">New Follow Up</h3>
              ...
              <?php
                ...
                $query = "SELECT * FROM onsite_inquiry WHERE inquiry_id=".$inqID."";
                $query2 = "SELECT * FROM user WHERE email='".$_SESSION['email']."'";
                $result = mysqli_query($con,$query);
            while($row=mysqli_fetch_array($result)){
                $person_name = $row['customer_name'];
                $person_email = $row['customer_email'];
                $person_phone = $row['customer_phone'];
            ...
            while($row2=mysqli_fetch_array($result2)){
              ...
              ?>
                <div class="card-body">
                  ...
                  <div class="form-group">
                    <label for="exampleInputName1" hidden>Inquiry ID</label>
                    <?php echo"<input readonly name='inqID' class='form-control' value='".$inqID."' id='inquiry-id' hidden>";?>
                  </div>


                  <div class="form-group">
                    <label for="exampleInputName1">Person Name</label>
                    <?php echo"<input type='text' readonly name='urn' class='form-control' value='".$person_name."' id='prsn-nm3' >";?>
                  </div>
                    
                    
                  <div class="form-group">
                    <label for="exampleInputName1">Person Email</label>
                    <?php echo"<input type='text' readonly class='form-control' value='".$person_email."' id='prsn-email'>";?>
                  </div>

                  <div class="form-group">
                    <label for="exampleInputName1">Person Contact Number</label>
                    <?php echo"<input type='text' readonly class='form-control' value='".$person_phone."' id='prsn-phone'>";?>
                  </div>

                  <div class="form-group">
                    <label for="exampleInputName1">Interested Product(s)</label>
                    <textarea type='text' readonly class='form-control' id='prd-name'><?php echo str_replace(",",", ", $product_name)."."; $product_name ?></textarea>
                  </div>

                  <div class="form-group">
                    <label for="exampleInputName1">Inquiry Date</label>
                    <?php echo"<input type='text' readonly class='form-control' value='".date("d-m-Y", strtotime($inquiry_date))."' id='inq-date'>";?>
                  </div>

                  <!--div class="form-group">
                    <label for="exampleInputName1">Follow Up Taker</label>
                    <?php //echo"<input type='text' readonly class='form-control' value='".$urn." - ".$name."' id='fup-taker'>";?>
                  </div-->
                  ...
                  <div class="form-group">
                      ...
                      <div class="input-group">
                        ...
                        <input type="date" class="form-control" data-inputmask-alias="datetime" data-inputmask-inputformat="yyyy-mm-dd" data-mask placeholder="yy-mm-dd" id="fup-date" name="inquiry-date" value="<?php echo $today;?>">
                      </div>
                  </div>


                  <div class="form-group">
                    <label for="exampleInputName1">Comments on Follow Up</label>
                    <?php echo"<textarea type='text' name='comments' class='form-control validate-input1' id='fup-comments' placeholder='Enter Follow Up Comments'> </textarea>";?>
                    <span  class="invalid-feedback">Follow Up Comments can't be empty</span>
                  </div>
                  ...
                  <div class="custom-control custom-switch">
                      ...
                      <label class="custom-control-label" for="customSwitch3">Need Another Follow Up?</label>
                    </div>
                 ...
                 <div class="form-group" id='follow-up-details-div' style='margin-top:20px'>
                    ...
                    <div class='card card-default'>
                        <div class='card-header'>
                            <label>Next Follow Up Details</label>
                        </div>
                      ...
                      <div class="input-group">
                        ...
                        <input type="date" class="form-control" data-inputmask-alias="datetime" data-inputmask-inputformat="yyyy-mm-dd" data-mask placeholder="yy-mm-dd" id="fup-next-date" name="fup-date">
                      </div>
                      <!-- /.input group -->
                  </div>
                  ...
                  <div class="form-group">
                    <label for="exampleInputName1">Reason For Follow Up</label>
                    <?php echo"<textarea type='text' name='comments' class='form-control' id='fup-next-reason' placeholder='Enter Comments on Inquiry'> </textarea>";?>
                  </div>
             ...
             <div class="card-footer">
                  <button  class="btn btn-primary" id="save-follow-up">Submit</button>
                </div>     
            </div>
            <!-- /.card -->
