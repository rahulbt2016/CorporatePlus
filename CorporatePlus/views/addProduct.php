              ...
              <div class="card-body" style="height: auto;">
                ...
                <div class="form-group">
                    ...
                    <?php
                        ...
                        echo "<input type='text' class='form-control' readonly name='product-code' id='product-code' value='".$newID."'>";
                    ?>
                </div>  
                  
                <div class="form-group">
                    <label for="exampleInputName1">Product Name</label>
                    <input type="text" class="form-control validate-input1"  id="product-name" placeholder="Enter Product Name">
                ...
                <div class="form-group">
                    ...
                    <div class="input-group">
                      <div class="custom-file">
                        <input type="file" class="custom-file-input" id="product-pic">
                ...
                <div class="form-group">
                    ...
                    <textarea name='product-description' class='form-control validate-input1' rows='4' id='product-description' placeholder='Enter description of the product'></textarea>
...
<!--                                    <span  class="invalid-feedback">Please Select atleast 1 raw material</span>-->
                ...
                <div class="form-group">
                    ...
                    <input type="number" class="form-control validate-input1" name='cost' min='1' id="unit_cost" placeholder="Enter Unit Cost">
              ...
              <div class="card-footer">
                  <button  class="btn btn-primary" id="add-new-product">Submit</button>
              </div>
            </div>
            <!-- /.card -->
          </div> 
