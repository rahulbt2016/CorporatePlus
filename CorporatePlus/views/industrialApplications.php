        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Industrial Applications</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
          ...
          <div class="col-12">
            <div class="card">
              <div class="card-header" style="background-color: #007BFF">
                 <div class='row'> 
                <h3 class="card-title col-md-9" style="color:white">List of Industrial Applications</h3>

                <div class="card-toolscol-md-3">
                  <div class="input-group input-group-sm">
                    <?php
                        ...
                        if($flag){
                            echo "<a data-toggle='dropdown' href='#'><i id='add-new-industrial-application-button' style='color:white; padding-top:8px ' title='Add New Industrial Application'  class='far fa-plus-square '></i></a>";  
                        }
                    ?>
                    <input type="text" name="table_search" id='industrial-applications-search-string' style="margin-left:20px" class="form-control" placeholder="Search">

                    <div class="input-group-append">
                      <button type="submit" id='industrial-applications-table-search' class="btn btn-default"><i class="fas fa-search"></i></button>
                    </div>
                  </div>
                </div>
                </div>
              ...
              <div class="card-body table-responsive p-0" style="height: 390px;">
                <table class="table table-head-fixed table-hover text-nowrap">
                  <thead>
                      <tr>
                      <th style='width:70%'>Industrial Application</th>
                      <th>Status</th>
                      ...
                      <?php
                        ...
                        $flag = 0;
                        while($row=mysqli_fetch_array($result)){
                            if($row['form_file']=='editIndustrialApplication.php')
                            $flag=1;
                        }
                        if($flag){
                            echo "<th>Edit</th>";
                  ...
                  <tbody id="industrial-applications-table-body">
                      <?php
                      
                      //$query="SELECT DISTINCT vendor_reg_num,vendor_name,gst_num,email,phone,raw_mat,added_by FROM vendor";
                      $query="SELECT * FROM industrial_applications ORDER BY active DESC,industry_name ASC";
...
$(function () {
  //Bootstrap Duallistbox
    ...
    $("#add-new-industrial-application-button").click(function(){
    window.location='addIndustrialApplication.php';
  });
