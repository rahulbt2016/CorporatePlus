  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Add New Manufactured Product</h1>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
                <li class="breadcrumb-item"><a href="dashboard.php">Home</a></li>
                <li class="breadcrumb-item"><a href="manufacturedProducts.php">Manufactured Products</a></li>
              <li class="breadcrumb-item active">Add New Manufactured Product</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
           ...
           <div class="col-12">
            <div class="card">
              <div class="card-header" style="background-color: #007BFF">
                <h3 class="card-title" style="color:white">New Manufactured Product</h3>
              ...
              <div class="card-body" style="height:auto;">
                ...
                <div class="form-group">
                  <label>Select Quantities of Raw Materials</label>
                  <div class='row' id='raw-mat-quantity-body'>
                <?php
                    $result = mysqli_query($con, "select * from products where active=1 ORDER BY product_name ASC");
                    while($row=mysqli_fetch_array($result)){
                    ...
                    $result = mysqli_query($con, "SELECT raw_mat FROM product_raw_mat WHERE product_id=".(int)$firstProductId);
                    while($row=mysqli_fetch_array($result)){
                ...
                <div class="form-group">
                    ...
                    <?php
                        ...
                        $tableName = "products_manufactured";
                    ...
                    ?>
                    <input type='number' class='form-control validate-input1' min='1' name='batch-number' value='<?php echo $newID; ?>' readonly id='batch-number'>
              ...
              <div class="card-footer">
                  <button  class="btn btn-primary" id="add-manufacctured-product">Submit</button>
                </div>
            </div>
            <!-- /.card -->
          </div> 
    ...
    $("#product").change(function(){
        ...
        $.ajax({
                ...
                data:
                    {
                        product: $productName,
                        action:'show-product-raw-mat-quantity'
                    },
                ...
                success: function(data){
                    $("#raw-mat-quantity-body").html(data);  
                }
