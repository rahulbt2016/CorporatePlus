              ...
              <form role="form">
                <div class="card-body">
                  ...
                  <div class="form-group">
                        ...
                        <input type="text" class="form-control validate-input1" name="user-type" id="designation-name" placeholder="Enter Designation Name">
                  </div>

                  
                  <div class="form-group">
                        <label for="exampleInputType1">Approximate Monthly Salary (₹)</label>
                        <input type="number" class="form-control validate-input1" name="designation-salary" id="designation-salary" placeholder="Enter Approximate Monthly Salary">
                  </div>  
...
<!--                        <div class="custom-control custom-checkbox">
                ...
                <div class="card-footer">
                  <button  class="btn btn-primary" id="add-designation">Submit</button>
                </div>
              </form>
            </div>
            <!-- /.card -->
                ...
                <div class="card card-primary">
                    ...
                    <tr>
                      ...
                      <?php
                        ...
                        $flag = 0;
                        while($row=mysqli_fetch_array($result)){
                            if($row['form_file']=='editDesignation.php')
                            $flag=1;
                        }
                        if($flag){
                            echo "<th>Edit</th>
                        ...
                        while($row=mysqli_fetch_array($result)){
                            ...
                            echo "
                                <tr>
                                    ...
                                    if($flag){
                                        echo"<td><a  data-toggle='dropdown' href='#'><i class='far fa-edit edit-designation-access'></i></a></td>
