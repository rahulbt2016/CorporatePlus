           ...
           <div class="col-12">
            <div class="card">
              <div class="card-header" style="background-color: #007BFF">
                <h3 class="card-title" style="color:white">New Order</h3>
              ...
              <div class="card-body" style="height: 680px;">
                ...
                <div class="form-group">
                  ...
                  <select id="vendor" class="form-control select2" style="width: 100%;">
                    <?php
                        $result = mysqli_query($con, "select * from vendor where active=1 ORDER BY vendor_name ASC");
                        while($row=mysqli_fetch_array($result)){
                ...
                <div class="form-group">
                  ...
                  <select id="raw-mat" class="form-control select2" style="width: 100%;">
                     
                    <?php
                        $result = mysqli_query($con, "select * from vendor where active=1 ORDER BY vendor_name ASC");
                        while($row=mysqli_fetch_array($result)){
                            $firstVendor = $row['vendor_id'];
                            break;
                        }
                        
                        $result = mysqli_query($con, "select * from vendor_raw_materials where vendor_id=".$firstVendor." ORDER BY raw_mat ASC");
                        while($row=mysqli_fetch_array($result)){
                ...
                <div class="form-group">
                    ...
                    <input type='number' class='form-control validate-input1' min='1' value='1' name='quantity' id='quantity' placeholder="Enter Quantity">
                    <span  class="invalid-feedback">Please enter valid cost quantity</span>
                </div>

                <div class="form-group">
                    <label for="exampleInputNumber1">Unit Cost(₹)</label>
                    <input type="number" class="form-control validate-input1" name='cost' min='1' id="cost" placeholder="Enter Unit Cost">
                    <span  class="invalid-feedback">Please enter valid cost</span>
                </div>  
            
                <div class="form-group">
                    <label for="exampleInputName1">Batch Number</label>
                    <input type='number' class='form-control validate-input1' min='1' name='batch-number' id='batch-number' placeholder="Enter Batch Number">
                    <span  class="invalid-feedback">Please enter valid Batch number</span>
                </div>
                ...
                <div class="form-group">
                    <label for="exampleInputFile">Upload Invoice (.pdf)</label>
                    <div class="input-group">
              ...
              <div class="card-footer">
                  <button  class="btn btn-primary" id="add-raw-mat-order">Submit</button>
                </div>
            </div>
            <!-- /.card -->
          </div> 
    ...
    $("#vendor").change(function(){
        ...
        $.ajax({
                ...
                data:
                    {
                        vendor: $vendor,
                        action:'show-raw-materials-list'
                    },
