          ...
          <div class="col-12">
            <div class="card">
              <div class="card-header" style="background-color: #007BFF">
                <h3 class="card-title" style="color:white">List of Products</h3>
                ...
                <div class="card-tools">
                  <div class="input-group input-group-sm" style="width: 250px;">
                    <?php
                        ...
                        if($flag){
                            echo "<a data-toggle='dropdown' href='#'><i id='add-new-product-button' style='color:white; padding-top:8px ' title='Add New Product'  class='far fa-plus-square '></i></a>";  
                        }
                    ?>
                    <input type="text" name="table_search" id='product-search-string' style="margin-left:20px" class="form-control" placeholder="Search">

                    <div class="input-group-append">
                      <button type="submit" id='product-table-search' class="btn btn-default"><i class="fas fa-search"></i></button>
                    </div>
                  </div>
                </div>
              </div>
                  ...
                  <tbody id="product-table-body">
                      ...
                      while($row=mysqli_fetch_array($result)){
                        ...
                        echo "<tr>";
                            ...
                            //echo"<td>".$row['product_raw_mat']."</td>";
                            ...
                            if($flag){
                                ...
                                echo"<td><a data-toggle='dropdown' href='#'><i style='color:red' title='Disable'  class='far fa-trash-alt disable-product'></i></a><input type='text' hidden value='".$row['product_id']."'></td>";
                                    ...
                                    //echo"<td><a data-toggle='dropdown' href='#'><i style='color:greeen'  class='far fa-trash-restore-alt delete-raw-mat'></i></a><input type='text'hidden value='".$row['raw_mat_code']."'></td>";

                                    //echo "<td><a data-toggle='dropdown' href='#'><i class='fas text-success fa-trash-restore-alt enable-product' title='Enable'></i></a><input type='text'hidden value='".$row['product_code']."'></td>";
                        ...
                        echo "<div class='row'>
                                ...
                                <div class='col-3'>Product Name</div><div class='col-1'>:</div><div class='col-8'>".$row['product_name']."</div>
                                <div class='col-3'>Category</div><div class='col-1'>:</div><div class='col-8'>".$row['category_name']."</div>
                                <div class='col-3'>Raw Materials</div><div class='col-1'>:</div><div class='col-8'>".$rawMatString.".</div>    
                                <div class='col-3'>Description</div><div class='col-1'>:</div><div class='col-8'>".$row['mini_description']."</div>
                                <div class='col-3'>Unit Cost</div><div class='col-1'>:</div><div class='col-8'>₹ ".$row['unit_cost']."</div>
                        ...
                        if($row['description_pdf']!=0){
                            echo "<div class='col-8'><a  data-toggle='dropdown' href='#'><i class='fas fa-file-pdf product-documentation' style='color:white'></i></a><input type='text' hidden value='".$row['product_id']."'></div>";
                        }        
                        else{
