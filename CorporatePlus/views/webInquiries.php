          ...
          <div class="col-12">
            <div class="card">
                <div class="card-header" style="background-color: #007BFF">
                    <div class='row'>
                    <h3 class="card-title col-md-9" style="color:white">Arrived Web Inquiries</h3>

                <div class="card-tools col-md-3">
                  <div class="input-group input-group-sm">

                    <input type="text" name="table_search" style="margin-left:20px" id="web-inquiry-search-string"  class="form-control" placeholder="Search">

                    <div class="input-group-append">
                      <button type="submit" class="btn btn-default" id="web-inquiry-table-search"><i class="fas fa-search"></i></button>
                    </div>
                  </div>
                </div>
              ...
              <div class="card-body table-responsive p-0" style="height: 390px;">
                <table class="table table-head-fixed table-hover text-nowrap">
                  ...
                  <tbody id="web-inquiry-table-body">
                    
                      <?php
                      
                        
                        
                        $result = mysqli_query($con,"SELECT web_inquiry.web_inquiry_id,web_inquiry.web_inquiry_reg_num,web_inquiry.inquirer_name,web_inquiry.inquirer_email,web_inquiry.inquirer_number,web_inquiry.inquiry_date, web_inquiry.product_id,web_inquiry.inquiry_allocated_to,products.product_name
                                                    FROM web_inquiry,products
                                                    WHERE
                                                    products.product_id=web_inquiry.product_id AND
                                                    web_inquiry.inquiry_allocated_to=0 
                        ...
                        while($row = mysqli_fetch_array($result)){
                            ...
                            echo "
                                    ...
                                    <div class='modal fade' id='allocate-inq-modal".$row['web_inquiry_id']."'>
                                        <div class='modal-dialog'>
                                          <div class='modal-content'>
                                            <div class='modal-header'>
                                              <h4 class='modal-title'>Inquiry Allocation</h4>
                                            ...
                                            <div class='modal-body'>
                                                ...
                                                echo "<div class='form-group'>
                                                        <label>Allocate To</label>
                                                            <select id='allocated-to-".$row['web_inquiry_id']."' class='form-control select2' style='width: 100%;'>";
                                                
                                                $result2 = mysqli_query($con,"SELECT user_id,user_name,user_reg_num
                                                                            FROM (SELECT user.user_id,user.user_name,user.user_reg_num,form.form_file
                                                                            ...
                                                                            access.form_id=form.form_id
                                                                            ORDER BY user.user_name ASC) AS T

                                                                            WHERE form_file IN ('assignedWebInquiries.php','displayInquiries.php','addInquiry.php')
                                                                            GROUP BY user_id
                                                                            HAVING COUNT(form_file)=3
                                                                            ORDER BY user_name ASC");
                                                    
                                                    
                                                while($row2 = mysqli_fetch_array($result2)){
                                                    echo "<option>".$row2['user_name']." - ".$row2['user_reg_num']."</option>";
                                                }    
                                          ...
                                          echo "</select>
                                            ...
                                            <div class='modal-footer justify-content-between'>
                                              ...
                                              <button type='button' class='btn btn-primary save-allocated-inquiry' style='font-size:14px'>Submit</button>
                                ...
                                echo "<div class='modal fade' id='modal-primary-".$row['web_inquiry_id']."'>
                                <div class='modal-dialog'>
                                    <div class='modal-content bg-primary'>
                                        <div class='modal-header'>
                                            <h4 class='modal-title'>Web Inquiry Description</h4>
                                            <button type='button' class='close' data-dismiss='modal' aria-label='Close'>
                                        ...
                                        <div class='modal-body'>";
                                          ...
                                          echo "<div class='col-4'>Inquiry Reg. Num.</div><div class='col-1'>:</div><div class='col-7'>".$row['web_inquiry_reg_num']."</div>";
                                          echo "<div class='col-4'>Inquiry Date</div><div class='col-1'>:</div><div class='col-7'>".date("d M, Y",strtotime($row['inquiry_date']))."</div>";
                                          echo "<div class='col-4'>Interested Product</div><div class='col-1'>:</div><div class='col-7'>".$row['product_name']."</div>";
                                          echo "<div class='col-4'>Inquiry Allocated To</div><div class='col-1'>:</div><div class='col-7'><span class='badge badge-warning'>PENDING</span></div>";
                                          echo "<div class='col-4'>Inquiry Allocated By</div><div class='col-1'>:</div><div class='col-7'><span class='badge badge-warning'>PENDING</span></div>";
                                          echo "<div class='col-4'>Scheduled Appointment</div><div class='col-1'>:</div><div class='col-7'><span class='badge badge-warning'>PENDING</span></div>";
                                          echo "<br><br><br>";
                                          echo "<div class='col-4'>Customer Name</div><div class='col-1'>:</div><div class='col-7'>".$row['inquirer_name']."</div>";
                                          echo "<div class='col-4'>Email</div><div class='col-1'>:</div><div class='col-7'>".$row['inquirer_email']."</div>";
                                          echo "<div class='col-4'>Phone</div><div class='col-1'>:</div><div class='col-7'>".$row['inquirer_number']."</div>";
                                          echo "</div>";
                                echo"   </div>
                                    </div>
                                </div>
                        ...
                        $result = mysqli_query($con,"SELECT web_inquiry.web_inquiry_id,web_inquiry.web_inquiry_reg_num,web_inquiry.inquirer_name,web_inquiry.inquirer_email,web_inquiry.inquirer_number,web_inquiry.inquiry_date, web_inquiry.product_id,web_inquiry.inquiry_allocated_to,web_inquiry.inquiry_allocator,web_inquiry.appointment_call,web_inquiry.appointment_timestamp,products.product_name
                                                    FROM web_inquiry,products
                                                    WHERE
                                                    products.product_id=web_inquiry.product_id AND
                                                    web_inquiry.inquiry_allocated_to>0 
                        ...
                        while($row = mysqli_fetch_array($result)){
                            ...
                            $result2 = mysqli_query($con,"SELECT * FROM user WHERE user_id=".(int)$row['inquiry_allocated_to']);
                            while($row2 = mysqli_fetch_array($result2)){
                                
                                $userName = $row2['user_name'];
                                $userRegNum = $row2['user_reg_num'];
                                
                                break;
                            }
                            
                            $result2 = mysqli_query($con,"SELECT * FROM user WHERE user_id=".(int)$row['inquiry_allocator']);
                            while($row2 = mysqli_fetch_array($result2)){
                                
                                $allocatorName = $row2['user_name'];
                                $allocatorRegNum = $row2['user_reg_num'];
                            ...
                            echo "<tr>";
                                ...
                                echo "<td>".$row['product_name']."</td>";
                                echo "<td><center><a href='#'><i class='far fa-eye' title='View More' data-toggle='modal' data-target='#modal-primary-".$row['web_inquiry_id']."'></i></a></center></td>";
                                echo "<td>".$userRegNum." - ".$userName."</td>";
                            echo "</tr>";
                                ...
                                <div class='modal-dialog'>
                                    <div class='modal-content bg-primary'>
                                        ...
                                        <div class='modal-body'>";
                                          ...
                                          echo "<div class='col-4'>Inquiry Date</div><div class='col-1'>:</div><div class='col-7'>".date("d M, Y",strtotime($row['inquiry_date']))."</div>";
                                          echo "<div class='col-4'>Interested Product</div><div class='col-1'>:</div><div class='col-7'>".$row['product_name']."</div>";
                                          echo "<div class='col-4'>Inquiry Allocated To</div><div class='col-1'>:</div><div class='col-7'>".$userRegNum." - ".$userName."</div>";
                                          echo "<div class='col-4'>Inquiry Allocated By</div><div class='col-1'>:</div><div class='col-7'>".$allocatorRegNum." - ".$allocatorName."</div>";
                                          if($row['appointment_call']==0){
                                              ...
                                              echo "<div class='col-4'>Scheduled Appointment</div><div class='col-1'>:</div><div class='col-7'>".date("d M, Y",strtotime($row['appointment_timestamp']))." at ".date("h:i a",strtotime($row['appointment_timestamp']))."</div>";
   ...
   //Initialize Select2 Elements
    $('.allocate-button').click(function(){
       //alert($(this).parent().parent().find('input').val());
        $("#allocated-to-"+$(this).parent().parent().find('input').val()).select2(); 
    });
 

  $(".allocate-button").mouseenter(function(){
      
      $(this).css('background-color','#FEB204');
  });
  
  $(".allocate-button").mouseleave(function(){
