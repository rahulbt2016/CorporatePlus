           ...
           <div class="col-12">
            <div class="card">
              <div class="card-header" style="background-color: #007BFF">
                <h3 class="card-title" style="color:white">New Barcode Generation</h3>
              ...
              <div class="card-body" style="height:auto;">
                ...
                <div class="form-group">
                    <label for="exampleInputName1">Barcode Quantity</label>
                    <input type='number' class='form-control validate-input1' min='1' value='1' name='quantity' id='barcode-quantity' placeholder="Enter quantity of barcodes needed">
              ...
              <div class="card-footer">
                  <button  class="btn btn-primary" id="generate-barcode">Go</button>
                </div>
            </div>
            <!-- /.card -->
          </div> 
