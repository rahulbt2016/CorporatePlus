              ...
              <form role="form">
                <div class="card-body">
                  ...
                  <div class="form-group">
                    <label for="exampleInputName1">User Registration Number</label>
                    <?php
                        $tableName = "user";
                        $columnName = "user_reg_num";
                        $prefix = "USR";
                        ...
                        echo "<input type='text' class='form-control' readonly name='urn' id='user-reg-num' value='".$newID."'>";
                    ?>
                  </div>
                    
                  <div class="form-group">
                    <label for="exampleInputName1">Name</label>
                    <input type="text" class="form-control validate-input1" name="name" id="user-name" placeholder="Enter Name">
                    <span  class="invalid-feedback">Name field can't be empty</span>
                  </div>

                  <div class="form-group">
                    <label for="exampleInputEmail1">Email Address</label>
                    <input type="email" class="form-control validate-input1" name="email" id="user-email" placeholder="Enter Email">
                  ...
                  <div class="form-group">
                    ...
                    <?php
                        ...
                        $tempPassword = substr(str_shuffle($data), 0, 10);
                        echo "<input type='password' name='password' readonly class='form-control validate-input1' value='".$tempPassword."' id='user-password' placeholder='Password'>";
                    ?>
                    <span  class="invalid-feedback">Please enter a valid password of length between 8 to 20</span>
                  </div>

                  <div class="form-group">
                        <label for="exampleInputType1">Select User Designation</label>
                        <select class="form-control validate-input1" placeholder="Select Type" id="user-type">
...
<!--                      <option>HR</option>
                          ...
                          <option></option>
                          <?php
                            $query = "SELECT designation_name FROM designation";
                            $result = mysqli_query($con,$query);
                            while($row=mysqli_fetch_array($result)){
                                echo "<option>".$row['designation_name']."</option>";
                            }
                          ?>

                        </select>
                        <span  class="invalid-feedback">Please select a designation</span>
                  </div>
                    
                    
                  <div class="form-group">
                    <label for="exampleInputName1">Monthly Salary (₹)</label>
                    <input type='number' class='form-control validate-input1' name='salary' id='user-salary'>
                    <span  class="invalid-feedback">Salary field can't be empty</span>
                  </div>

                  <div class="form-group">
                    <label for="exampleInputNumber1">Phone Number</label>
                    <input type="text" class="form-control validate-input1" name='number' id="user-number" placeholder="Phone Number">
                  ...
                  <div class="form-group">
                    ...
                    <div class="input-group">
                      <div class="custom-file">
                        <input type="file" class="custom-file-input" id="user-pic">
            ...
            <div class="col-md-4">
                ...
                <div class="card card-primary">
                    <div class="card-header">
                        <h3 class="card-title">Approximate Monthly Salary</h3>
                    </div>
