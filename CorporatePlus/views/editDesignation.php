<?php
    ...
    if(!isset($_SESSION['editDesignationName']))
        header("Location: dashboard.php");
    
    $designationName = $_SESSION['editDesignationName'];
?>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Edit Designation Form</h1>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
                <li class="breadcrumb-item"><a href="dashboard.php">Home</a></li>
                <li class="breadcrumb-item"><a href="designation.php">Designation</a></li>
            ...
            <div class="card card-primary">
              ...
              <form role="form">
                <div class="card-body">
                  ...
                  <?php
                    $query = "select * from designation where designation_name='".$_SESSION['editDesignationName']."'";
                    $result = mysqli_query($con, $query);
                    while ($row = mysqli_fetch_array($result)) {
                        $designationSalary = $row['approx_salary'];
                    }
                  ?>
                  <div class="form-group">
                        <label for="exampleInputType1">Designation</label>
                        <input type="text" class="form-control validate-input1" readonly name="user-type" id="designation-name2" value='<?php echo $_SESSION['editDesignationName'] ?>' placeholder="Enter Designation Name">
                  </div>

                  
                  <div class="form-group">
                        <label for="exampleInputType1">Approximate Monthly Salary (₹)</label>
                        <input type="number" class="form-control validate-input1" name="designation-salary" value='<?php echo $designationSalary ?>' id="designation-salary2" placeholder="Enter Approximate Monthly Salary">
                  </div>  
                    
                  <div class="form-group">
                      <label for="exampleInputType1">Give Access:</label>
                  </div> 
...
<!--                        <div class="custom-control custom-checkbox">
                          <input class="custom-control-input" type="checkbox" id="adduser">
                          <label for="adduser" class="custom-control-label">Add User</label>
                        </div>

                        <div class="custom-control custom-checkbox">
                          <input class="custom-control-input" type="checkbox" id="availableuser">
                          <label for="availableuser" class="custom-control-label">Available Users</label>
                        </div>

                        <div class="custom-control custom-checkbox">
                          <input class="custom-control-input" type="checkbox" id="addvendor">
                          <label for="addvendor" class="custom-control-label">Add Vendor</label>
                        </div>

                        <div class="custom-control custom-checkbox">
                          <input class="custom-control-input" type="checkbox" id="vendors">
                          <label for="vendors" class="custom-control-label">Available Vendors</label>
                        </div>

                        <div class="custom-control custom-checkbox">
                          <input class="custom-control-input" type="checkbox" id="order_rawmat">
                          <label for="order_rawmat" class="custom-control-label">Order Raw Materials</label>
                        </div>

                         <div class="custom-control custom-checkbox">
                          <input class="custom-control-input" type="checkbox" id="add_rawmat">
                          <label for="add_rawmat" class="custom-control-label">Add Raw Materials</label>
                        </div>


                        <div class="custom-control custom-checkbox">
                          <input class="custom-control-input" type="checkbox" id="avail_rawmat">
                          <label for="avail_rawmat" class="custom-control-label">Available raw material</label>
                        </div>

                        
                        <div class="custom-control custom-checkbox">
                          <input class="custom-control-input" type="checkbox" id="return_rawmat">
                          <label for="return_rawmat" class="custom-control-label">Return Raw Materials</label>
                        </div>

                        <div class="custom-control custom-checkbox">
                          <input class="custom-control-input" type="checkbox" id="addproduct">
                          <label for="addproduct" class="custom-control-label">Add Products</label>
                        </div>

                        <div class="custom-control custom-checkbox">
                          <input class="custom-control-input" type="checkbox" id="avail_products">
                          <label for="avail_products" class="custom-control-label">Available Products</label>
                        </div>

                        <div class="custom-control custom-checkbox">
                          <input class="custom-control-input" type="checkbox" id="webinquiry">
                          <label for="webinquiry" class="custom-control-label">Web Inquiry</label>
                        </div>

                        <div class="custom-control custom-checkbox">
                          <input class="custom-control-input" type="checkbox" id="onsiteinquiry">
                          <label for="onsiteinquiry" class="custom-control-label">On-site Inquiry</label>
                        </div>

                        <div class="custom-control custom-checkbox">
                          <input class="custom-control-input" type="checkbox" id="customer">
                        ...
                        <div class="custom-control custom-checkbox">
                          <input class="custom-control-input" type="checkbox" id="purchased_products">
                          <label for="Purchased_products" class="custom-control-label">Purchased Products</label>
                        </div>

                        <div class="custom-control custom-checkbox">
                          <input class="custom-control-input" type="checkbox" id="barcode">
                          <label for="barcode" class="custom-control-label">Barcode Generation</label>
                        </div>

                        <div class="custom-control custom-checkbox">
                          <input class="custom-control-input" type="checkbox" id="service_product">
                          <label for="service_product" class="custom-control-label">Service for Product</label>
                        </div>

                        <div class="custom-control custom-checkbox">
                          <input class="custom-control-input" type="checkbox" id="allocate_petty">
                          <label for="allocate_petty" class="custom-control-label">Allocate Petty Cash</label>
                        </div>

                        <div class="custom-control custom-checkbox">
                          <input class="custom-control-input" type="checkbox" id="commodity_req">
                          <label for="commodity_req" class="custom-control-label">Request for Commodity
                          </label>
                        </div>

                        <div class="custom-control custom-checkbox">
                          <input class="custom-control-input" type="checkbox" id="curr_comlist">
                          <label for="curr_comlist" class="custom-control-label">Current Commodity List</label>
                        </div>

                        <div class="custom-control custom-checkbox">
                          <input class="custom-control-input" type="checkbox" id="add_applicants">
                          <label for="add_applicants" class="custom-control-label">Add Applicants</label>
                        </div>

                        <div class="custom-control custom-checkbox">
                          <input class="custom-control-input" type="checkbox" id="list_applicants">
                          <label for="list_applicants" class="custom-control-label">List of Applicants</label>
                        </div>-->
                        ...
                        <?php
                            ...
                            while($row=mysqli_fetch_array($result)){
                                ...
                                $flag = 0;
                                $query2 = "select * from access where designation_name='".$_SESSION['editDesignationName']."'";
                                $result2 = mysqli_query($con,$query2);
                                while($row2=mysqli_fetch_array($result2)){
                                    if($row['form_id'] == $row2['form_id']){
                                        $flag = 1;
                                    }
                                }
                                if($flag){
                                   echo "<div class='custom-control custom-checkbox'>
                                        <input class='custom-control-input form-access-checkbox' checked type='checkbox' id='access-form-".$row['form_id']."'>
                                        <label for='access-form-".$row['form_id']."' style='font-weight: normal;' class='custom-control-label'>".$row['form_name']."</label>
                                        <input type='text' hidden readonly value='".$row['form_id']."'>
                                      </div>"; 
                                }
                                else{
                                    echo "<div class='custom-control custom-checkbox'>
                                        <input class='custom-control-input form-access-checkbox' type='checkbox' id='access-form-".$row['form_id']."'>
                                        <label for='access-form-".$row['form_id']."' style='font-weight: normal;' class='custom-control-label'>".$row['form_name']."</label>
                                        <input type='text' hidden readonly value='".$row['form_id']."'>
                                      </div>"; 
                                }
                ...
                <div class="card-footer">
                  <button  class="btn btn-primary" id="save-edited-designation">Save</button>
                </div>
              </form>
            </div>
            <!-- /.card -->
            ...
            <div class="col-md-4">
                ...
                <div class="card card-primary">
                    <div class="card-header">
                        <h3 class="card-title">Existing Designations</h3>
                    </div>
                        ...
                        while($row=mysqli_fetch_array($result)){
                            ...
                            echo "
                                <tr>
                                    ...
                                    <td><a  data-toggle='dropdown' href='#'><i class='far fa-edit edit-designation-access'></i></a></td>
                                    <td><a  data-toggle='dropdown' href='#'><i style='color:red'  class='far fa-trash-alt delete-designation'></i></a></td>
                                </tr>";
                        }
...
<script src="../dashboard_assets/dist/js/../dashboard_assets/pages/dashboard.js"></script>
