          ...
          <div class="col-md-7">
            <div class="card">
              <div class="card-header" style="background-color: #007BFF">
                <h3 class="card-title" style="color:white">List of Raw Materials</h3>
           ...
           <div class="col-md-5">
            <div class="card">
              ...
              <div class="card-body" style="height: 520px;">
                  ...
                  <a data-toggle='modal' href='#' data-target='#modal-primary'><i  class='far fa-eye '></i></a>
                  
                  <div class='modal fade' id='modal-primary'>
                <div class='modal-dialog'>
                  <div class='modal-content bg-primary'>
                    <div class='modal-header'>
                      <h4 class='modal-title'>Raw Materials Used</h4>
